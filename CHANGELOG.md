...
- Upgrade `lint-staged` version to `15.1.0`
- Upgrade `prettier` version to `3.1.0`
- Update `eslint` version to `8.54.0`
- Update `husky` version to `8.0.3`
- Update `stylelint-config-prettier` version to `9.0.5`
- Update `stylelint` version to `14.16.1`

## 5.2.0

- Upgrade `husky` version to `8.0.2`
- Upgrade `lint-staged` version to `13.0.4`
- Update `eslint` version to `8.28.1`
- Update `eslint-config-prettier` version to `8.5.0`
- Update `prettier` version to `2.8.0`
- Update `stylelint-config-prettier` version to `9.0.1`
...
- Upgrade `husky` version to `7.0.4`
- Upgrade `lint-staged` version to `12.1.2`
- Upgrade `stylelint` version to `14.1.0`
- Upgrade `stylelint-config-prettier` version to `9.0.3`
- Upgrade `stylelint-config-sass-guidelines` version to `9.0.1`
- Update `prettier` version to `2.5.0`

## 4.7.1

- Bump `eslint` version to `7.29.0`
- Bump `prettier` version to `2.3.2`

## 4.7.0

- Bump `eslint` version to `7.29.0`
- Bump `prettier` version to `2.3.1`
